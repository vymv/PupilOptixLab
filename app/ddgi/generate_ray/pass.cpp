...
RayGeneratePass::RayGeneratePass(std::string_view name) noexcept
    : Pass(name) {
...
void RayGeneratePass::Run() noexcept {
    m_timer.Start();
    {
        if (m_dirty) {
...
void RayGeneratePass::InitOptixPipeline() noexcept {
...
void RayGeneratePass::SetScene(World *world) noexcept {
...
void RayGeneratePass::SetSBT(scene::Scene *scene) noexcept {
...
void RayGeneratePass::BindingEventCallback() noexcept {
...
void RayGeneratePass::Inspector() noexcept {
